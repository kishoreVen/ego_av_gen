"""MeshFlow VAE: point-cloud/mesh-conditioned encoder-decoder producing per-vertex
mask/position/normal/adjacency-embedding heads, plus edge extraction into a Mesh.

Port of meshflow/meshflow/models/meshflow_vae.py (~/code/meshflow). Meshflow's
