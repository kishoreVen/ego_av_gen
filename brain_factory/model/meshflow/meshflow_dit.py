"""MeshFlow DiT: AdaLN-Zero diffusion transformer with RoPE and visual cross-attention,
operating on the MeshFlow VAE's latent sequence.

Port of meshflow/meshflow/models/meshflow_dit.py (~/code/meshflow). Meshflow's
